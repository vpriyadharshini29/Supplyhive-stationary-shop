...
// 📌 Categories Data (IDs can remain simple 1..9)
const categories = {
  "Offices Basics": {
    banner:
      "./images/o-b.png",
          ...
          {filteredProducts.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProducts.map((product) => (
                <div
                  key={product.id}
                  className="bg-blue-200 rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition"
                >
                  <img
                    src={product.image}
                    alt={product.name}
                  ...
                  <div className="p-4 text-center">
                    ...
                    <button
                      onClick={() => addToCart(product, activeCategory)}
                      className="mt-3 bg-white text-blue-600 font-semibold px-4 py-2 rounded-lg shadow hover:bg-gray-100"
                    >
                      Add to Cart
                    </button>
                  </div>
